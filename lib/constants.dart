...
static const int bpmAutomaticIncrementValue = 5;
  ...
  final String tripletsWithAccents = "RlrlllRlrlllRlrlllRlrlll,rrrLrlrrrLrlrrrLrlrrrlrl,RlrlrlrrrLrlRlrlrlrrrLrl,RlllRlllRlrrLrrrLrrrLrll,RllllRlllRlrLrrrrLrrrLrll,RllRllRlllllLrrLrrLrrrrr,RlrlrLrlRlllRlrlrLrlRlll,LrlrlRlrLrrrLrlrlRlrLrrr,RlrlrLrrrrrrLrlrlRllllll,rlrLllLllrlrLllLllrlRlrl,RllRllLrrLrrRllRllLrrLrr,RlrLrrLllLllLrlRllRrrRrr,RlRlrlRrrRrrLrLrlrLllLll,RRRlrlrlrLLLRRRlrlrlrLLL,RrlLrrLlrRllRrlLrrLlrRll,rrRllLrrrrrrllLrrRllllll,rrrRlrlllLrlrrrRlrlllLrl,RlllllllRRllRlllllllRRll,LrrrrrrrLLrr,LrrrrrrrLLrr,RrrrLlllRrrrLlllRrrrLlll,RllRllRLRLrrLrrLrrLRLRll,rllRllrllLrrlrrLrrlrrRll,rrLrllRlrrllrrLrllRlrrll,rrllRlrllRlrllrrLrlrrLrl,RlrrLrllrrrrLrllRlrrllll,RllrrrLrlRlrLrrllllRlrLrl,RlrRlrLlrLrrLrlLrlRrlRll,RlrlrlrrllrrLrlrlrllrrll,RlrLrlRlrLrrLrlRlrLrlRll,RllLllrrLrrLRllLllrrLrrL,RlrLrlrrrLrrLrlRlrlllRll,RllLrrRllLrrRllLrrRllLrr,RlrllRllRllRLrlrrLrrLrrL,rrlrrlRlrllrllrLrlrlrlrl,rrllRllrrLrrllRllrrLrlrl,RlrllRlrlrrLRlrllRLrlrrL,RlrLllLllLllLrlRrrRrrRrr,RlrLrlRrrRrrLrlRlrLllLll,RlrLrlRlrLrlLllLllRrrRrr,RlrLrlRlrLrlRrrRrrRrrRrr,LrlRlrLrlRlrLllLllLllLll,RlrLrlRlrLrlrrRrrRrrRrrR,LrlRlrLrlRlrllLllLllLllL,RlrLrlRlrlrLllLllLRrrRrr,LrlRlrLrlrlRrrRrrRLllLll,RlrLrlrrRrrRLrlRlrllLllL,RlrLrlRlrLrlrRrrRrrRrrRr,LrlRlrLrlRlrlLllLllLllLl,RlrLrlrRrrRrLrlRlrlLllLl,rlRLllrlRLllrlRLllrlRLll,";

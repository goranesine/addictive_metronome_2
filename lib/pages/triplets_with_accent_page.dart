...
import 'package:addictive_metronome_2/models/triple_with_accent_model.dart';
...
class TripletsWithAccentsPage extends StatefulWidget {
  const TripletsWithAccentsPage({super.key});


  @override
  State<TripletsWithAccentsPage> createState() => _TripletsWithAccentsPage();
}

class _TripletsWithAccentsPage extends State<TripletsWithAccentsPage> {
  final am = TripleNoteWithAccentModel();
